...
&=((-1)\cdot a+1\cdot a)+(-a) &\quad &\text{(Axiom 6, mult. identity)}\\
&=((-1)+1)\cdot a+(-a) &\quad &\text{(Axiom 8, distributive)}\\
&=0\cdot a+(-a) &\quad &\text{(Axiom 5, additive idnverse)}\\
...
Then we define the ordering on the rational numbers $\frac ab$ and $\frac cd$ with positive denominators $b,d>0$ by:
$$\frac ab<\frac cd \quad \text{ if and only if } \quad ad<bc$$
$$\frac ab>\frac cd \quad \text{ if and only if } \quad ad>bc$$
